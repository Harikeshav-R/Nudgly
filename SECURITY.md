...
Currently, only the latest major version is supported with security updates.
...
We will endeavor to respond to vulnerability reports within 48 hours and provide a timeline for a fix.
